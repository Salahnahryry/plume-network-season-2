...
\    \_\  \  ___/|   |  (  <_> )___ \|   Y  \  / /_/ \  ___/ 
 \______  /\___  >___|  /\____/____  >___|  /__\____ |\___  >
        \/     \/     \/           \/     \/        \/    \/ 
"""
    print(Fore.LIGHTGREEN_EX + Style.BRIGHT + banner_art + Style.RESET_ALL)
    print(f"{Fore.GREEN}==================[ {Style.BRIGHT}Genoshide{Style.NORMAL} ]=================={Style.RESET_ALL}")
    print(f"{Fore.WHITE}>> Plume Network :: Retrodrop Automation <<{Style.RESET_ALL}")
    print(f"{Fore.WHITE}>> Status: Online | Mainnet: Season II <<{Style.RESET_ALL}\n")
